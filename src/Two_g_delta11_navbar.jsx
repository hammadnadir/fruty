...
export default function Two_g_delta11_navbar() {
  return (
    <div className=' bg-[url("/images/menured2.png")] w-[100%] bg-cover  md:mt-[-40px] md:h-[210px] bg-no-repeat fixed z-10'>
      <div className="flex md:justify-between mx-[60px] justify-center md:mt-[2.5%] items-center">
