...
export default function Tripletap_masterblend_navbar() {
  return (
    <div className=' bg-[url("/images/menugreen.png")] w-[100%] bg-cover  md:mt-[-40px] md:h-[210px] bg-no-repeat fixed z-10'>
