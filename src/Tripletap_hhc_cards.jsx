...
import { card6 } from '../data';


export default function Tripletap_hhc_cards() {
  return (
    <>
<div className="pb-[60px] ">
          <div className="grid grid-col md:grid-cols-2  md:px-[20px]  lg:grid-cols-5 md:gap-9  items-center justify-items-center pt-[50px] md:pt-[20px]">
    <Slide top>
